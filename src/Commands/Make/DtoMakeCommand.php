...
class DtoMakeCommand extends GeneratorCommand
{
    ...
    public function getDestinationFilePath(): string
    {
        ...
        $filePath = GenerateConfigReader::read('dtos')->getPath() ?? config('modules.paths.app_folder').'Dtos';
    ...
    protected function getDtoName(): array|string
    {
    ...
    {
        return config('modules.paths.generator.dtos.namespace', 'Dtos');
    }
